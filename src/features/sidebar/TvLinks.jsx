...
const Tvlinks = [
    { activeIcon: <MovieIcon />, notActiveIcon: <MovieOutlinedIcon />, label: "Feed", url: "feed/tv" },
    { activeIcon: <VideoLibraryIcon />, notActiveIcon: <VideoLibraryOutlinedIcon />, label: "Top Rated", url: "top_rated/tv" },
    { activeIcon: <WhatshotOutlinedIcon />, notActiveIcon: <WhatshotIcon />, label: "Trending", url: "trending/tv" },
    { activeIcon: <FavoriteOutlinedIcon />, notActiveIcon: <FavoriteBorderOutlinedIcon />, label: "Popular", url: "popular/tv" },
  ];
function TvLinks() {
  ...
  return (
    ...
    <ListItemIcon>{open ? <TvIcon /> : <TvOutlinedIcon />}</ListItemIcon>
    <ListItemText
      primary={"TV"}
